...
import eventKeyTypeCode from '../nav/types/event-key.md?raw';
import navBreakpointTypeCode from '../nav/types/nav-breakpoint.md?raw';
import navContextValueTypeCode from '../nav/types/nav-context-value.md?raw';
import navItemPropsTypeCode from '../nav/types/nav-item-props.md?raw';
import navLinkPropsTypeCode from '../nav/types/nav-link-props.md?raw';
import navPropsTypeCode from '../nav/types/nav-props.md?raw';
import navVariantTypeCode from '../nav/types/nav-variant.md?raw';
